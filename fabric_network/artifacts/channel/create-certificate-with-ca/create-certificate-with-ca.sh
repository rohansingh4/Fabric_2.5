...
createCretificatesForOrderer() {
  ...
  fabric-ca-client enroll -u https://admin:adminpw@localhost:9054 --caname ca.orderer.example.com --tls.certfiles ${PWD}/fabric-ca/orderer/tls-cert.pem
  ...
  fabric-ca-client register --caname ca.orderer.example.com --id.name orderer --id.secret ordererpw --id.type orderer --tls.certfiles ${PWD}/fabric-ca/orderer/tls-cert.pem
  ...
  fabric-ca-client register --caname ca.orderer.example.com --id.name orderer2 --id.secret ordererpw --id.type orderer --tls.certfiles ${PWD}/fabric-ca/orderer/tls-cert.pem
  ...
  fabric-ca-client register --caname ca.orderer.example.com --id.name orderer3 --id.secret ordererpw --id.type orderer --tls.certfiles ${PWD}/fabric-ca/orderer/tls-cert.pem
  ...
  fabric-ca-client register --caname ca.orderer.example.com --id.name ordererAdmin --id.secret ordererAdminpw --id.type admin --tls.certfiles ${PWD}/fabric-ca/orderer/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca.orderer.example.com -M ${PWD}/../crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/msp --csr.hosts orderer.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/orderer/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer2:ordererpw@localhost:9054 --caname ca.orderer.example.com -M ${PWD}/../crypto-config/ordererOrganizations/example.com/orderers/orderer2.example.com/msp --csr.hosts orderer2.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/orderer/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer2:ordererpw@localhost:9054 --caname ca.orderer.example.com -M ${PWD}/../crypto-config/ordererOrganizations/example.com/orderers/orderer2.example.com/tls --enrollment.profile tls --csr.hosts orderer2.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/orderer/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer3:ordererpw@localhost:9054 --caname ca.orderer.example.com -M ${PWD}/../crypto-config/ordererOrganizations/example.com/orderers/orderer3.example.com/msp --csr.hosts orderer3.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/orderer/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer3:ordererpw@localhost:9054 --caname ca.orderer.example.com -M ${PWD}/../crypto-config/ordererOrganizations/example.com/orderers/orderer3.example.com/tls --enrollment.profile tls --csr.hosts orderer3.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/orderer/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@localhost:9054 --caname ca.orderer.example.com -M ${PWD}/../crypto-config/ordererOrganizations/example.com/users/Admin@example.com/msp --tls.certfiles ${PWD}/fabric-ca/orderer/tls-cert.pem
